...
const Suppliers = () => {
  ...
  const fetchSuppliers = useCallback(async (page = 1, search = searchTerm) => {
    try {
      setLoading(true)
      setError(null)
    ...
    if (sortBy !== 'none') {
      filtered = filtered.sort((a, b) => {
        switch (sortBy) {
          ...
          case 'status':
            return (a.IsActiveYN ? 'active' : 'inactive').localeCompare(b.IsActiveYN ? 'active' : 'inactive')
          default:
            return 0
        }
      })
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-blue-900 text-white">
              <tr>
                <th className="px-6 py-4 text-left font-semibold">SUPPLIER ID</th>
              ...
              {loading ? (
                ...
                filteredSuppliers.map((supplier, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-gray-700">{supplier.ContactNumber || 'N/A'}</td>
